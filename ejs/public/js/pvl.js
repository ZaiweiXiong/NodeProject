...
$(document).ready(function(){ //get products list
	...
	$("#products").change(function(){
		...
		$.post("http://localhost:8084/"+selectvalue,{
		},
...
function producttoVersion(obj){
	...
	var txt2=$("<select style="+"width:30%"+" "+"onchange="+"VersionToLanguage()"+" "+
...
function VersionToLanguage(){
	...
	var selectversion = $( "#versions" ).val();
		...
		$.post("http://localhost:8084/"+selectversion,{
...
function getLanguage(obj){
	...
	var txt2=$("<select style="+"width:20%"+" "+"onchange="+"OnLanguage()"+" "+
